...
class AttendeesControllerTest < ActionController::TestCase
  ...
  test "should create attendee" do
    assert_difference('Attendee.count') do
      post :create, attendee: { attendance: @attendee.attendance, comment: @attendee.comment, name: @attendee.name }
    end
  ...
  test "should update attendee" do
    patch :update, id: @attendee, attendee: { attendance: @attendee.attendance, comment: @attendee.comment, name: @attendee.name }
    assert_redirected_to attendee_path(assigns(:attendee))
  end
